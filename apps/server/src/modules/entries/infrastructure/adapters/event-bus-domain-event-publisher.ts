...
import type { EntriesDomainEventPublisher } from "../../application/services/domain-event-publisher";

@Injectable()
export class EventBusEntriesDomainEventPublisher implements EntriesDomainEventPublisher {
