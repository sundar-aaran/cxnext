...
@Controller("common/stock-rejection-types")
export class StockRejectionTypesController extends CommonMasterControllerBase {
  public constructor(
    ...
    super("stockRejectionTypes", listUseCase, getUseCase, createUseCase, updateUseCase, deleteUseCase);
  }
