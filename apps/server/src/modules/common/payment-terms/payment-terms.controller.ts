...
@Controller("common/payment-terms")
export class PaymentTermsController extends CommonMasterControllerBase {
  public constructor(
    ...
    super("paymentTerms", listUseCase, getUseCase, createUseCase, updateUseCase, deleteUseCase);
  }
