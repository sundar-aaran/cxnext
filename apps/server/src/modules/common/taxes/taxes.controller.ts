...
@Controller("common/taxes")
export class TaxesController extends CommonMasterControllerBase {
  public constructor(
    ...
    super("taxes", listUseCase, getUseCase, createUseCase, updateUseCase, deleteUseCase);
  }
