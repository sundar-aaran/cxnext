...
@Controller("common/accounting-years")
@RequirePermissions(modulePermission("common", "read"))
export class AccountingYearsController extends CommonMasterControllerBase {
  public constructor(
    ...
    super("accountingYear", listUseCase, getUseCase, createUseCase, updateUseCase, deleteUseCase);
  }
