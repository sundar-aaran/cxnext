...
@Controller("common/months")
@RequirePermissions(modulePermission("common", "read"))
export class MonthsController extends CommonMasterControllerBase {
  public constructor(
    ...
    super("months", listUseCase, getUseCase, createUseCase, updateUseCase, deleteUseCase);
  }
