...
const tableName = "common_product_categories";
const sortColumn = "position_order";
const columns = [
  { key: "code", type: "string" },
  { key: "name", type: "string" },
  { key: "description", type: "string" },
  { key: "image", type: "string" },
  { key: "position_order", type: "number" },
  { key: "show_on_storefront_top_menu", type: "boolean" },
  { key: "show_on_storefront_catalog", type: "boolean" },
...
@Injectable()
export class ProductCategoriesRepository implements OnModuleDestroy {
  ...
  public async get(id: number) {
    ...
    if (!row) throw new NotFoundException("ProductCategories record " + id + " was not found.");
  ...
  public async drop(id: number) {
    ...
    if (Number(result.numUpdatedRows) === 0) throw new NotFoundException("ProductCategories record " + id + " was not found.");
  ...
  public async forceDelete(id: number) {
    ...
    if (Number(result.numDeletedRows) === 0) throw new NotFoundException("ProductCategories record " + id + " was not found.");
