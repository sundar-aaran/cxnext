...
@Controller("common/hsn-codes")
export class HsnCodesController extends CommonMasterControllerBase {
  public constructor(
    ...
    super("hsnCodes", listUseCase, getUseCase, createUseCase, updateUseCase, deleteUseCase);
  }
