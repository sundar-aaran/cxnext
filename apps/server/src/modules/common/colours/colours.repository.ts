...
const tableName = "common_colours";
const sortColumn = "name";
const columns = [
  { key: "code", type: "string" },
  { key: "name", type: "string" },
  { key: "description", type: "string" },
  { key: "hex_code", type: "string" },
...
@Injectable()
export class ColoursRepository implements OnModuleDestroy {
  ...
  public async get(id: number) {
    ...
    if (!row) throw new NotFoundException("Colours record " + id + " was not found.");
  ...
  public async drop(id: number) {
    ...
    if (Number(result.numUpdatedRows) === 0) throw new NotFoundException("Colours record " + id + " was not found.");
  ...
  public async forceDelete(id: number) {
    ...
    if (Number(result.numDeletedRows) === 0) throw new NotFoundException("Colours record " + id + " was not found.");
