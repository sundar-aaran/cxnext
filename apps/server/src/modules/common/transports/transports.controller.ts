...
@Controller("common/transports")
export class TransportsController extends CommonMasterControllerBase {
  public constructor(
    ...
    super("transports", listUseCase, getUseCase, createUseCase, updateUseCase, deleteUseCase);
  }
