...
const tableName = "common_warehouses";
const sortColumn = "name";
const columns = [
  { key: "code", type: "string" },
  { key: "name", type: "string" },
  { key: "is_default_location", type: "boolean" },
  { key: "country", type: "string" },
  { key: "state", type: "string" },
  { key: "district", type: "string" },
  { key: "city", type: "string" },
  { key: "pincode", type: "string" },
  { key: "address_line1", type: "string" },
  { key: "address_line2", type: "string" },
...
@Injectable()
export class WarehousesRepository implements OnModuleDestroy {
  ...
  public async get(id: number) {
    ...
    if (!row) throw new NotFoundException("Warehouses record " + id + " was not found.");
  ...
  public async drop(id: number) {
    ...
    if (Number(result.numUpdatedRows) === 0) throw new NotFoundException("Warehouses record " + id + " was not found.");
  ...
  public async forceDelete(id: number) {
    ...
    if (Number(result.numDeletedRows) === 0) throw new NotFoundException("Warehouses record " + id + " was not found.");
