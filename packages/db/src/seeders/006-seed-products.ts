...
const productSeeds = [
  {
    uuid: "seed-product-aster-linen-shirt",
    code: "PRD0001",
    name: "Aster Linen Shirt",
    slug: "aster-linen-shirt",
    sku: "ASTER-LINEN-SHIRT-001",
    brand_id: "brand:aster-loom",
    brand_name: "Aster Loom",
    category_id: "product-category:t-shirts",
    category_name: "Shirts",
    product_group_id: "product-group:apparel",
    ...
    primary_image_url: "https://placehold.co/900x1200/e8dfd4/2d211b?text=Aster+Linen+Shirt",
    tag_names: ["core", "men"],
  },
  {
    uuid: "seed-product-luna-utility-tote",
    code: "PRD0002",
    name: "Luna Utility Tote",
    slug: "luna-utility-tote",
    sku: "LUNA-UTILITY-TOTE-01",
    brand_id: "brand:northline",
    brand_name: "Northline",
    category_id: "product-category:accessories",
    category_name: "Accessories",
    product_group_id: "product-group:accessories",
    product_group_name: "Accessories",
    product_type_id: "product-type:finished-good",
    product_type_name: "Finished Good",
    base_price: 2490,
    cost_price: 1490,
    storefront_department: "accessories",
    primary_image_url: "https://placehold.co/900x1200/dad4cb/2d211b?text=Luna+Utility+Tote",
    tag_names: ["core", "accessories"],
  },
] as const;
